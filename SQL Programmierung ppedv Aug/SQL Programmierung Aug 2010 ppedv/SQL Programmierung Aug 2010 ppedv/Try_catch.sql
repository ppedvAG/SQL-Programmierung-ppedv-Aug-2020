...
--die reine SQL Abfrage würde gar nicht erst ausgefürht werden, die Prozedur allerdings schon...
...
-- Falls er nicht in den catch läuft, muss auch commitet werden sonst fehlermeldung
commit transaction
